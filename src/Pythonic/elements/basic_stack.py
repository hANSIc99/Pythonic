...
from PyQt5.QtWidgets import (QVBoxLayout, QHBoxLayout, QLabel, QTextEdit, QWidget, QComboBox, QCheckBox, QFileDialog, QPushButton)
...
class ExecStack(ElementMaster):
    ...
    def edit(self):
        ...
        self.help_text_1.setText(QC.translate('', 'Help Text 1')) 

        self.help_text_2 = QLabel()
        self.help_text_2.setText(QC.translate('', 'Help Text 2'))
